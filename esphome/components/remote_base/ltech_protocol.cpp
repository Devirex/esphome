...
static const int32_t HEADER_HIGH_US = 1 * TICK_US;
static const int32_t HEADER_LOW_US = 3.8 * TICK_US;
static const int32_t BIT_ONE_HIGH_US = 2 * TICK_US;
static const int32_t BIT_ONE_LOW_US = 0.9 * TICK_US;
static const int32_t BIT_ZERO_HIGH_US = 1 * TICK_US;
static const int32_t BIT_ZERO_LOW_US = 1.8 * TICK_US;
